...
class AInt(object):
    ...
    def __add__(self, other):
        ...
        for a, b in zip_longest(self.bits,  other.bits, fillvalue=False):
            ...
            #  a^b^c  #I added this kaydon
            out.append(a^b^c)  # TODO: replace false
            # carry is whether there were at least two bits on
            c = (a and b or a and c or b and c)   # TODO: replace false
           # a and b or a and c or b and c #I added this kaydon
        out.append(c)
        return out
    ...
    def __mul__(self, other: 'AInt'):
        ...
        """
        # TODO: replace this with algorithm on page 15
